...
public class Base64Encoder {
	    ...
	    throws IOException
	  {
	    ...
	    for (int i1 = paramInt1; i1 < paramInt1 + j; i1 += 3) {
	    ...
	    throws IOException
	  {
	    ...
	    while ((i1 > paramInt1) && 
	      (ignore((char)paramArrayOfByte[(i1 - 1)])))
	    {
	      i1--;
	    }
	    ...
	    i2 = nextI(paramArrayOfByte, i2, i3);

	    while (i2 < i3) {
	      int i = this.decodingTable[paramArrayOfByte[(i2++)]];

	      i2 = nextI(paramArrayOfByte, i2, i3);

	      int j = this.decodingTable[paramArrayOfByte[(i2++)]];

	      i2 = nextI(paramArrayOfByte, i2, i3);

	      int k = this.decodingTable[paramArrayOfByte[(i2++)]];

	      i2 = nextI(paramArrayOfByte, i2, i3);

	      int m = this.decodingTable[paramArrayOfByte[(i2++)]];
	    ...
	    n += decodeLastBlock(paramOutputStream, (char)paramArrayOfByte[(i1 - 4)], (char)paramArrayOfByte[(i1 - 3)], (char)paramArrayOfByte[(i1 - 2)], (char)paramArrayOfByte[(i1 - 1)]);
	    ...
	    throws IOException
	  {
	    ...
	    while ((i1 > 0) && 
	      (ignore(paramString.charAt(i1 - 1))))
	    {
	      i1--;
	    }
